...
public class EmployeeService {
    ...
    public EmployeeService(EmployeeDAO employeeDAO, JWTService jwtService, EncryptionService encryptionService, EmailService emailService, EmployeeVerificationTokenDAO employeeVerificationTokenDAO) {
